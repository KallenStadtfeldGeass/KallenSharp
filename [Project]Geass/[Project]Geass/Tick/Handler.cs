...
namespace _Project_Geass.Tick
{
    ...
    internal class Handler
    {
        ...
        /// <summary>
        ///     Checks the cache synchronize.
        /// </summary>
        /// <returns></returns>
        public static bool CheckCacheSync() => MyTicker.CheckTick($"{Names.ProjectName}.CacheSync");
        ...
        public static void Load(bool humanize)
        {
            ...
            MyTicker.AddTick($"{Names.ProjectName}.CacheSync", 500, 500);
        }

        /// <summary>
        ///     Uses the cache synchronize.
        /// </summary>
        public static void UseCacheSync() => MyTicker.UseTick($"{Names.ProjectName}.CacheSync");
