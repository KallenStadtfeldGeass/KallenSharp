...
namespace S_Plus_Class_Kalista.Handlers
{
    internal class Humanizer : Core
    {
        ...
        private static Menu _Menu()
        {
            ...
            subMenuDelay.AddItem(new MenuItem(DelayItemBase + "Slider.LevelDelay", "Level Delay").SetValue(new Slider(500, 50, 1000)));
            subMenuDelay.AddItem(new MenuItem(DelayItemBase + "Slider.EventDelay", "Check Delay").SetValue(new Slider(100, 50, 200)));
            subMenuDelay.AddItem(new MenuItem(DelayItemBase + "Slider.SoulBoundDelay", "SoulBound Delay").SetValue(new Slider(250, 50, 1000)));
            subMenuDelay.AddItem(new MenuItem(DelayItemBase + "Slider.ItemDelay", "Item Delay").SetValue(new Slider(200, 50, 1000)));
            subMenuDelay.AddItem(new MenuItem(DelayItemBase + "Slider.TrinketDelay", "Trinket Delay").SetValue(new Slider(500, 50, 2000)));
