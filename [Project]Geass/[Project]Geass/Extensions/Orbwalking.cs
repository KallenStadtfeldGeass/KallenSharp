...
namespace LeagueSharp.Common
{
    ...
    /// </summary>
    public static class OrbwalkingEx
    {
        ...
        /// The attack offset
        /// </summary>
        public static float AttackOffset = 10f;
            ...
            public virtual AttackableUnit GetTarget()
            {
                    ...
                    || mode == OrbwalkingMode.Freeze)
                {
                    ...
                    foreach (var minion in MinionList)
                    {
                        ...
                        var predHealth = HealthPrediction.GetHealthPrediction(minion, t, this.FarmDelay) - AttackOffset;
                        ...
                        if (minions.Any())
                        {
                            ...
                            if (turretMinion != null)
                            {
                                     ...
                                     i = i + closestTower.AttackDelay * 1000)
                                {
                                    ...
                                    var predHP =
                                        (int)
                                        HealthPrediction.LaneClearHealthPrediction(turretMinion, time > 0 ? time : 0) - AttackOffset;
                                    if (predHP > 0)
                                    {
                                        hpLeft = (int)predHP;
                                        turretAttackCount += 1;
