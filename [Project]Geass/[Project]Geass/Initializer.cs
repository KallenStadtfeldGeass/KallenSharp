...
namespace _Project_Geass
{
    internal class Initializer
    {
        ...
        public Initializer()
        {
            ...
            if (!Module.Champions.Core.Bootloader.ChampionBundled.ContainsKey(StaticObjects.Player.ChampionName)) return;
            if (!Module.Champions.Core.Bootloader.ChampionBundled[StaticObjects.Player.ChampionName]) return;
            ...
            Module.Champions.Core.Bootloader.Load(manaEnabled, orbWalker);
        }
